...
export default function Layout() {
  ...
  return (
    <div ref={layoutRef} className="flex h-screen bg-background overflow-hidden">
      ...
      <div className={`fixed inset-y-0 left-0 z-50 w-72 transform transition-transform duration-300 ease-out lg:hidden pb-20 pb-safe ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
